package crakjie.ipranges.v4

import java.net.InetAddress

import crakjie.ipranges.IPRange
...
case class IP (value : Int) extends AnyVal {
  ...
  *           like x.x.x.1 = 1
  ...
  /**
    ...
    */
  @inline
  def incrementBy(n :Int): IP = IP(value + n)
  ...
  /**
    ...
    */
  @inline
  def increment: IP = incrementBy(1)
...
object IP {
  ...
  val ipRegex: Regex = """\s*([0-9]*).([0-9]*).([0-9]*).([0-9]*)\s*""".r
